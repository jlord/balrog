      ...
      generateTemplates(opts, function (err, tpl) {
        ...
        mkdirp('site/blog/page/', function() {
          ...
          for (var i = 0; i < totalPages; i++) {
            ...
            var content = { "posts": pagesPosts.pop(), "page": i, "previous": i - 1, "next": i + 1 }
            ...
            // if (i = 0) $('turn-previous').addClass('end-of-pages')
            // if (i = totalPages) $('turn-next').addClass('end-of-pages')
