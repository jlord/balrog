// this should maybe probably be a partial and template and not in js!

module.exports = function formatHeader(page, opts) {
  var url = pageURL(page.output)

  var title = "<a href='" + url + "'><h1 class='post-title'>" + page.content.title + "</h1></a>"
  ...
  var body = page.content.content

  var newContent = header + body
...
function buildMeta(page) {
  ...
  if (page.content.tags) {
    meta.push("<li>" + page.content.tags.join(", ") +"</li>")
  }
  return meta
}
